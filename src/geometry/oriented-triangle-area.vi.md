...
Từ diện tích có dấu này, ta vừa có thể lấy diện tích thông thường không âm (bằng giá trị tuyệt đối của diện tích có dấu), vừa xác định các điểm theo thứ tự đã cho nằm theo chiều kim đồng hồ hay ngược chiều kim đồng hồ (điều này hữu ích, chẳng hạn, trong các thuật toán bao lồi).


## Tính toán
Ta dùng tính chất định thức của ma trận $2\times 2$ bằng diện tích có dấu của hình bình hành sinh bởi các vector cột (hoặc hàng) của ma trận.
