...
Như vậy ta đã chứng minh mỗi lần lặp của vòng bên trong đều làm con trỏ $r$ tiến sang phải. Vì $r$ không thể lớn hơn $n-1$, vòng lặp bên trong sẽ không chạy quá $n-1$ lần.

**Ghi chú bản dịch:** Vì đoạn được biểu diễn theo dạng nửa mở [l, r), biên phải r có thể bằng n. Phát biểu nguồn về giới hạn n-1 lệch một đơn vị; lập luận tuyến tính chỉ cần r tăng đơn điệu và không vượt quá n.
